From 4b56abcc13582f886073311dc4af0a18ac1780b1 Mon Sep 17 00:00:00 2001
From: Bruno Dias <dias.h.bruno@gmail.com>
Date: Wed, 7 Jun 2017 22:42:42 -0300
Subject: [PATCH] [chore] improving build and publish pipeline.
...
---
 ...
 package.json            | 13 ++-------
 scripts/build           |  2 --
 scripts/dev-examples    |  3 --
 scripts/preview-release |  2 --
 scripts/release         |  3 --
 scripts/test            |  2 --
 scripts/version         | 21 ++++++++++++++
 ...
 delete mode 100755 scripts/dev-examples
 delete mode 100755 scripts/preview-release
 delete mode 100755 scripts/release
 delete mode 100755 scripts/test
 create mode 100644 scripts/version

diff --git a/.travis.yml b/.travis.yml
index 29a568b..8635d81 100644
--- a/.travis.yml
+++ b/.travis.yml
@@ -7,3 +7,5 @@ node_js:
 before_script:
...
+	@echo "  make publish      - publish the docs on gh-pages and version on npm."
+
+info:
...
+
+publish-version:
+	@echo npm publish `$(JQ) '.version' package.json`
+
+publish-docs:
+	cd _book
+	git init
...
+	cd ..
+
+publish: version build publish-docs publish-version
diff --git a/package.json b/package.json
index e815000..50e8767 100644
--- a/package.json
+++ b/package.json
@@ -13,15 +13,8 @@
     "example": "examples"
...
index 547bfc7..0000000
--- a/scripts/build
+++ /dev/null
@@ -1,2 +0,0 @@
-#!/bin/sh
-node_modules/.bin/webpack --config webpack.dist.config.js
diff --git a/scripts/dev-examples b/scripts/dev-examples
deleted file mode 100755
index a213dd3..0000000
--- a/scripts/dev-examples
+++ /dev/null
@@ -1,3 +0,0 @@
-#!/bin/sh
